...
#------------------------------------------------
#lst = daily_sales.replace (";,;", "+")
#split_sales = lst.split()


#daily_transactions_split = []

#for element in split_sales:
 # daily_transactions_split.append(element)
...
# Replace every instance of ";,;" with an unused character to avoid confusing later functions
...
for transaction in transactions_clean:
  ...
  threads_sold.append(transaction[2])
